...
import { faPen, faRemove, faCheck, faPlus } from '@fortawesome/free-solid-svg-icons';
      ...
      {isAuth ?
        <>
          <div className="flex flex-row my-2 justify-between items-center">
                ...
                ? <>
                  <div>
                    <input
                      ...
                      className={`border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-${nameEditingError ? 'red' : 'blue'}-500 focus:border-${nameEditingError ? 'red' : 'blue'}-500 block w-full p-2.5`}
            ...
            <div style={{ width: 40, height: 40, borderRadius: 16, backgroundColor: 'gray' }}></div>
          </div>
